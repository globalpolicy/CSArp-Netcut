...
namespace CSArp {
    public partial class Form1 : Form, IView {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            if (toolStripComboBoxDevicelist.Items.Count > 0) {
                toolStripComboBoxDevicelist.SelectedIndex = 0;
                toolStripComboBoxDevicelist.Text = toolStripComboBoxDevicelist.Items[0].ToString();
            }
        }
        ...
        private void listView1_MouseDoubleClick(object sender, MouseEventArgs e) {
            if (listView1.SelectedItems.Count == 1)
                listView1.SelectedItems[0].SubItems[4].Text = Interaction.InputBox("Enter client name for " + listView1.SelectedItems[0].SubItems[1].Text, " Enter client name");
        }
    }
}
